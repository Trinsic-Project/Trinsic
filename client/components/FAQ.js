    ...
    <div id="faq-container">
      ...
      <div className="faq-question">
        ...
        <ul className="faq-answer">
          <li>The blockchain, a value-exchange protocol, is an incorruptible digital ledger of economic transactions that can be programmed to record not just financial transactions but virtually everything of value.</li>
          <li>A blockchain is a continuously growing list of chronological and publically available records, called blocks, which are linked and secured using cryptography.</li>
          <li>The blockchain is a distributed ledger technology that underlies cryptocurrencies like Bitcoin and platforms like Ethereum. It provides a way to record and transfer data that is transparent, safe, auditable, and resistant to outages. The blockchain has the ability to make the organizations that use it transparent, democratic, decentralized, efficient, and secure.</li>
        </ul>
        <br></br>
      ...
      <div className="faq-question">
        ...
        <ul className="faq-answer">
          <li>A smart contract is a computer protocol intended to digitally facilitate, verify, or enforce the negotiation or performance of a contract. Smart contracts allow the performance of credible transactions without third parties.</li>
          <li>A smart contract is a computer code built onto the blockchain that executes automatically, allowing the exchange of anything of value (money, property, content, etc) when certain conditions, namely those of the contract, are met.</li>
          <li>While a standard contract outlines the terms of a relationship (usually one enforceable by law), a smart contract enforces a relationship with cryptographic code. Put differently, smart contracts are programs that execute exactly as they are set up to by their creators.</li>
        </ul>
        <br></br>
      ...
      <div className="faq-question">
        ...
        <ul className="faq-answer">
          <li>To actually execute smart contract code on the Ethereum platform, someone has to send enough Ether as a transaction fee. The amount of Ether needed depends on the computing resources required. This payment is necessary for the Ethereum nodes and miners participating and providing their computing power, energy, bandwidth, and electricity.</li>
          <li>The minimum fee necessary for a transaction to be processed and confirmed is based on the intersection of supply and demand in the blockchain's free market for block space.</li>
          <li>The block reward is essentially a revenue item for miners for solving a complex algorithmic problem, and a cost item for consumers who store content on the blockchain. Typically, miners choose which transactions they want to include in each block, based on how high their transaction fees are. The higher the transaction fee, the higher priority your transaction will have, meaning the faster it will be included as a block on the blockchain.</li>
        </ul>
        <br></br>
      ...
      <div className="faq-question">
        ...
        <ul className="faq-answer">
          <li>You may have heard that miners are solving difficult mathematical problems, but that's not true at all. What they're actually doing is trying to be the first miner to come up with a 64-digit hexadecimal number (a "hash") that is less than or equal to the target hash. It is guesswork.</li>
          <li>Miners search for an acceptable hash by choosing a number, converting the number, and checking. If the hash doesn’t have the right number of leading zeroes, they change the number, convert the number, and check again.</li>
          <li>Because it is practically impossible to predict the outcome of input, hash functions can be used for proof of work and validation. Bitcoin miners will compete to find an input that gives a specific value (a number with multiple zeros at the start). The difficulty of these puzzles is measurable. However, they cannot be cheated on. This is because there is no way to perform better than by guessing blindly.</li>
        </ul>
        <br></br>
